    ...
    implements FIFAConstants
{
    ...
    public List getFacts()
    {
        ...
        if(conn != null)
        {
            ...
            PreparedStatement preparedStatement = conn.prepareStatement(propertiesUtilities.getProperty(propertiesUtilities.getFactResource(), "sql.factsSelect"));
            ResultSet rs;
            FactBean factBean;
        ...
        throws BuildFactsException
    {
        ...
        try
        {
            ...
            {
                PropertiesUtilities propertiesUtilities = PropertiesUtilities.getInstance();
                PreparedStatement preparedStatement = conn.prepareStatement(propertiesUtilities.getProperty(propertiesUtilities.getFactResource(), "sql.currentWinStreak"));
                preparedStatement.setString(1, versionId);
        ...
        throws BuildFactsException
    {
        ...
        try
        {
            ...
            {
                PropertiesUtilities propertiesUtilities = PropertiesUtilities.getInstance();
                PreparedStatement preparedStatement = conn.prepareStatement(propertiesUtilities.getProperty(propertiesUtilities.getFactResource(), "sql.currentLossStreak"));
                preparedStatement.setString(1, versionId);
                preparedStatement.setString(2, versionId);
                for(ResultSet rs = preparedStatement.executeQuery(); rs.next();)
                    numberOfGames = rs.getInt(1);
